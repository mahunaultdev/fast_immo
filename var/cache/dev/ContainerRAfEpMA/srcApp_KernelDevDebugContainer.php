...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getFormulairecontactControllerService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ControllerTrait.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'FormulairecontactController.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SX1ZQzLL2t', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SQq74E50l3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6l1dF+XZzP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lCNNizMuPC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uFjGwMpGvx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uj43p3HoYT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DFU2lqeI8k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jgtkq2aYJP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd1165 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer9e8a2 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesbd5df = [
        
    ];

    public function getConnection()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getConnection', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getMetadataFactory', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getExpressionBuilder', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'beginTransaction', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getCache', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getCache();
    }

    public function transactional($func)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'transactional', array('func' => $func), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->transactional($func);
    }

    public function commit()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'commit', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->commit();
    }

    public function rollback()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'rollback', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getClassMetadata', array('className' => $className), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'createQuery', array('dql' => $dql), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'createNamedQuery', array('name' => $name), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'createQueryBuilder', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'flush', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'clear', array('entityName' => $entityName), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->clear($entityName);
    }

    public function close()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'close', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->close();
    }

    public function persist($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'persist', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'remove', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'refresh', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'detach', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'merge', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getRepository', array('entityName' => $entityName), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'contains', array('entity' => $entity), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getEventManager', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getConfiguration', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'isOpen', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getUnitOfWork', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getProxyFactory', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'initializeObject', array('obj' => $obj), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'getFilters', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'isFiltersStateClean', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'hasFilters', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return $this->valueHolderd1165->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer9e8a2 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd1165) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd1165 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd1165->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__get', ['name' => $name], $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        if (isset(self::$publicPropertiesbd5df[$name])) {
            return $this->valueHolderd1165->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd1165;
    ...
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;
    ...
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__isset', array('name' => $name), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;
    ...
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__unset', array('name' => $name), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;
    ...
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__clone', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        $this->valueHolderd1165 = clone $this->valueHolderd1165;
    }

    public function __sleep()
    {
        $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, '__sleep', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;

        return array('valueHolderd1165');
    }
    ...
    {
        $this->initializer9e8a2 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer9e8a2;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer9e8a2 && ($this->initializer9e8a2->__invoke($valueHolderd1165, $this, 'initializeProxy', array(), $this->initializer9e8a2) || 1) && $this->valueHolderd1165 = $valueHolderd1165;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd1165;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd1165;
    }
}
